...
@section('content')
    ...
    <div class="row justify-content-md-center">
        <a href="{{ route('print',$invoice->id) }}" class="btn btn-primary btn-lg" style="margin-right: 10px">print</a>
        <a href="{{ route('pdf',$invoice->id) }}" class="btn btn-success btn-lg" style="margin-right: 10px">Export to Pdf</a>
        <a href="{{ route('mail',$invoice->id) }}" class="btn btn-dark btn-lg">Send To Mail</a>
    </div>
@endsection